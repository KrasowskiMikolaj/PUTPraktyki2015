/** @file controllerSim.h
 *
 * implementation - Controller with usb2dynamixel
 * Author1: Pawel Szczygiel
 */

#ifndef CONTROLLERSIM_H_INCLUDED
#define CONTROLLERSIM_H_INCLUDED
...
namespace simulator {
    ...
    Controller* createControllerSim(void);
};
 ...
 */
class ControllerSim : public Controller{
    public:
        /// Pointer
        typedef std::unique_ptr<ControllerSim> Ptr;
...
#endif // CONTROLLERSIM_H_INCLUDED
